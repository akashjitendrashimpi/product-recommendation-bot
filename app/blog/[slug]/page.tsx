...
export default async function BlogPostPage(
  ...
  const jsonLd = {
    ...
    url: `https://www.qyantra.online/blog/${post.slug}`,
    image: post.cover_image || "https://www.qyantra.online/web-app-manifest-512x512.png",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <Link
          href="/blog"
          className="inline-flex items-center gap-2 text-sm text-blue-600 font-semibold hover:text-blue-700 mb-8"
        >
        ...
        <div className="mt-12 bg-gradient-to-br from-blue-600 to-purple-700 rounded-3xl p-8 text-center text-white">
          ...
          <p className="text-blue-100 mb-5 text-sm">
            Join Qyantra and earn real money completing simple tasks
          </p>
          <Link
            href="/auth/sign-up"
