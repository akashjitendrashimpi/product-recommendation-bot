    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-md border-b border-gray-100 z-50">
        <div className="max-w-6xl mx-auto px-4 h-14 sm:h-16 flex items-center justify-between">
          ...
          {/* CTA — client component, no hydration issue */}
          <HeaderCTA />
        </div>
      </header>

      {/* ── HERO ── */}
      <section className="pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-20 px-4 bg-gradient-to-b from-blue-50/60 to-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Subheadline */}
          <p className="text-lg sm:text-xl text-gray-500 mb-8 max-w-xl mx-auto leading-relaxed">
            Try apps, write reviews, complete surveys.
            Get paid directly to your{" "}
            <span className="font-bold text-gray-700">Paytm, GPay or PhonePe.</span>
          </p>
      ...
      {/* ── HOW IT WORKS ── */}
      <section id="how-it-works" className="py-14 sm:py-20 px-4 bg-gray-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div key={i} className="bg-white rounded-3xl p-6 sm:p-8 text-center shadow-sm border border-gray-100 hover:shadow-md transition-shadow group">
                <div className={`w-16 h-16 ${item.color} rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-md group-hover:scale-105 transition-transform duration-300 relative`}>
      ...
      {/* ── TASK TYPES ── */}
      <section id="tasks" className="py-14 sm:py-20 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-gray-500 mt-3 max-w-lg mx-auto text-sm sm:text-base">No skills needed. If you have a smartphone, you can earn.</p>
          </div>
      ...
      {/* ── EARNINGS ESTIMATE ── */}
      <section id="earnings" className="py-14 sm:py-20 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-gray-500 mt-3 text-sm sm:text-base">Based on typical task payouts. No exaggerations, no false promises.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6">
            {[
              ...
              <div key={i} className={`rounded-2xl p-6 text-center border-2 transition-all ${
                ...
                <p className="text-xs text-gray-500">{tier.tasks}</p>
                <p className="text-xs text-gray-400 mt-1">{tier.time}</p>
              </div>
            ))}
          </div>
      ...
      {/* ── IS THIS LEGIT? — keep, gold for India ── */}
      <section className="py-14 sm:py-20 px-4 bg-orange-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 max-w-lg mx-auto text-sm sm:text-base">We understand the skepticism. Here's the complete, honest truth:</p>
          </div>
      ...
      <section className="py-14 sm:py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5">
            {[
              { icon: Zap, title: "Instant Earnings", desc: "Tasks without proof requirements credit to your balance immediately.", color: "bg-yellow-50 text-yellow-600" },
              { icon: Shield, title: "Secure & Private", desc: "Your data is encrypted. Passwords are hashed. We never sell your info.", color: "bg-blue-50 text-blue-600" },
              ...
              { icon: Users, title: "Refer & Earn", desc: "Earn ₹20 for every friend who joins. They get ₹10 bonus too.", color: "bg-pink-50 text-pink-600" },
              { icon: BarChart3, title: "Track Everything", desc: "See your balance, task history, and payout status in real time.", color: "bg-orange-50 text-orange-600" },
            ].map((feature, i) => (
      ...
      <section className="py-12 sm:py-16 px-4 bg-gradient-to-r from-purple-50 to-blue-50">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-sm mx-auto text-sm sm:text-base">
            ...
            <span className="font-bold text-purple-600">₹20</span> when a friend joins.
            They get <span className="font-bold text-blue-600">₹10</span> signup bonus.
          </p>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-3xl p-8 sm:p-14 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-center gap-4 mt-5 text-blue-300 text-xs">
                <span className="flex items-center gap-1"><CheckCircle className="w-3.5 h-3.5" /> No credit card</span>
                <span className="flex items-center gap-1"><CheckCircle className="w-3.5 h-3.5" /> No investment</span>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between gap-8 mb-8">
            ...
            <div className="max-w-xs">
              ...
              <p className="text-xs mt-3 text-gray-600">
                📧{" "}
                <a href="mailto:contactqyantra@gmail.com" className="hover:text-gray-300 transition-colors">
          ...
          <div className="border-t border-gray-800 pt-6 space-y-3">
            <p className="text-xs text-gray-600 leading-relaxed">
              <strong className="text-gray-500">Disclosure:</strong> Qyantra is an incentive-based rewards platform. Users receive monetary compensation for completing genuine advertiser tasks including app installations, product trials, reviews, and surveys. This constitutes incentive traffic. Task availability and earning potential vary by region, time, and advertiser demand. All earnings estimates on this page are indicative only — actual earnings are not guaranteed and depend solely on tasks completed by the user.
            </p>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
              <p className="text-xs text-gray-700">© 2026 Qyantra. All rights reserved. Made with ❤️ in India.</p>
              <p className="text-xs text-gray-700">This platform is intended for users 18 years of age and above.</p>
            </div>
          </div>
        </div>
      </footer>
